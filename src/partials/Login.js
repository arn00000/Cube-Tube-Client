    ...
    <>
      <div className="pt-10 px-1 flex justify-center items-center">
        <div className="p-4 w-full max-w-md bg-white sm:rounded-xl sm:shadow-2xl sm:p-6 md:p-8">
          <form className="space-y-4" onSubmit={onSubmitHandler} method="POST">
            ...
            {error ? (
              <div
                id="alert-2"
                className="flex rounded-lg dark:bg-red-200"
                role="alert"
              >
                <svg
                  aria-hidden="true"
            ...
            <div className="flex items-start">
              ...
              <h1 className="ml-auto text-sm text-orange-700 hover:underline">
                Forgot Password?
              </h1>
            </div>
